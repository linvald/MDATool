...
public class IconUtil {
	...
	public static ImageIcon getAnyImageIcon(String pathName, int size, Class clazz){
		if (size != 16 && size != 24) {
					return null;
		}
		ImageIcon icon=null;		
		
			icon = new ImageIcon(clazz.getResource(pathName));
		
		return icon;
	}
	public static ImageIcon getHomeMadeIcon(String name, int size){
		return iconUtils.getIcon("homeMade", name, size);
	}
}
